...
export default function AuditDetailPage() {
    ...
    const auditDocRef = useMemoFirebase(() => {
        ...
        return doc(firestore, 'users', user.uid, 'webAudits', auditId);
        ...
        return (
            <div className="w-full max-w-4xl space-y-6">
                 <div className="flex items-center gap-2 mb-2">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight">Audit Result</h1>
                </div>
    ...
    return (
        <div className="w-full max-w-4xl">
            ...
            <AuditResultDisplay audit={audit.auditResult} url={audit.url} />
        </div>
    );
}

...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // The logic in AuthProvider will handle redirecting to the dashboard.
      toast({
        title: "Login Successful",
        description: "Redirecting you to the dashboard.",
      });
    ...
    <div className="flex min-h-screen items-center justify-center bg-black p-4">
      <Card className="mx-auto max-w-sm w-full bg-gray-900/50 border-gray-800">
        ...
        <CardContent>
          ...
          <Button variant="outline" className="w-full bg-gray-800 border-gray-700 hover:bg-gray-700" onClick={handleGoogleLogin} disabled={loading || googleLoading || !auth}>
